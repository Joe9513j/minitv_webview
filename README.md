...
> ⚠️ 当前版本为测试版本，仅在部分 Android 7.0及以上的手机上进行过简单测试通过。V1.1.5身边没电视测试，盲码，需要自行试试。
> 📦 下载地址：[app-release-v1.1.5.zip](https://raw.githubusercontent.com/Joe9513j/webtv/refs/heads/main/app-release.zip)
